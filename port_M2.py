...
for etf in liste_etf:
    vars()[etf.lower().replace(" ", "_")] = pd.DataFrame(
        investpy.etfs.get_etf_historical_data(etf, "united states", "01/01/2008","01/01/2021", 
                                              stock_exchange=None, 
                                              as_json=False, 
                                              order="ascending",
                                              interval="Daily"))
...
for stock in liste_stock:
    vars()[stock.lower()] = pd.DataFrame(
        investpy.stocks.get_stock_historical_data(stock, "united states", "01/01/2008", "01/01/2021",
                                                  as_json=False,
                                                  order="ascending",
                                                  interval="Daily"))
